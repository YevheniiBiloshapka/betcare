...
function copySlotLib() {
  return gulp.src('src/js/slots/slot-lib.js') // Make sure this is the correct source path
      .pipe(gulp.dest('dist/js/')); // This should be the correct destination path
}
/**
 * Экспорт сценариев
 * */
export { dev, build, deployZIP, deployFTP, createSvgSprite, isBuild, isDev , copySlotLib};
